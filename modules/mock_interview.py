...
def analyze_answers_with_ai(answers):
    analysis_prompt = "Analyze the following answers for an interview. Provide feedback on clarity, correctness, and improvement suggestions:\n\n"
    for i, answer in enumerate(answers, start=1):
        analysis_prompt += f"Answer {i}: {answer}\n\n"
